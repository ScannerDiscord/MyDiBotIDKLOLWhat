...
class BotInfo():
    ...
    async def botinfo(self , ctx):
        ...
        embed.add_field(name="Bot Version", value="1.5", inline=True)
        embed.add_field(name="Bot Owner", value="Scanner#4797", inline=True)
        embed.add_field(name="Co-Owner", value="Sup#2533 ", inline=True)
        embed.add_field(name="Bot Language", value="Python-Async", inline=True)
